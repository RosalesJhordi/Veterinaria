...
<body class="selection:bg-white selection:text-orange-600">
    <div class="fixed z-50 justify-center items-center w-full bg-gray-800 h-screen" id="menu">
        <div class="flex flex-col justify-center mt-20 items-center gap-5 text-white uppercase font-extrabold text-2xl">
            ...
            <a href="{{ route('Productos.index') }}"
                class="border-b-2 border-transparent hover:border-white">Productos</a>
    ...
    <header class="shadow-md header p-2 px-20 flex justify-between items-center">
        ...
        <nav class="uppercase font-extrabold nav  text-gray-400 flex gap-10">
            ...
            <a href="{{ route('Servicios') }}" class="hover:text-black border-b-2 border-transparent hover:border-black"
                id="servi">servicios</a>
            <a href="{{ route('Productos.index') }}"
                class="hover:text-black border-b-2 border-transparent hover:border-black" id="product">Productos</a>
            <a href="{{ route('Sobre-nosotros') }}"
                class="hover:text-black border-b-2 border-transparent hover:border-black" id="sb">sobre
                nosotros</a>
        </nav>
    ...
    <main class="px-20 relative">
        ...
        @auth
            @if (auth()->user()->email == 'yhordiyhom65@gmail.com')
                <a href="{{ route('Panel') }}">
                    <div id="btn-panel"
                        class="bg-orange-600  fixed right-0 bottom-96 h-1/6 px-10 p-2 flex items-center justify-center gap-2"
                        style="border-radius: 200px 0px 10px 200px;
    ...
    <footer class="w-full footer flex gap-10 justify-center items-center p-2 text-center bg-gray-300">
        <div>
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15719.773862222859!2d-76.2363243!3d-9.938662099999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91a7c2e25c51eee9%3A0x791adbfd296fbb35!2sPlaza%20de%20Armas%20de%20Hu%C3%A1nuco!5e0!3m2!1ses-419!2spe!4v1701913384330!5m2!1ses-419!2spe"
